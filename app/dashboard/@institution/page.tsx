  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-10 w-full overflow-x-hidden">
      ...
      <motion.div
        ...
        className="relative group overflow-hidden rounded-[2rem] bg-linear-to-br from-emerald-600/80 to-teal-700/80 p-4 md:p-8 shadow-[0_20px_50px_rgba(16,185,129,0.2)]"
      >
